<template>
  <div>
    ...
    <h4 class="lighter">
      ...
      <router-link class="pink" to="/business/course"> {{ course.name }}</router-link>

      <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
      <router-link class="pink" to="/business/chapter"> {{ chapter.name }}</router-link>
    </h4>
    <hr>
                ...
                <div class="col-sm-10">
                  ...
                  <div v-show="section.video" class="row">
                    <div class="col-md-9">
                      ...
                      <video v-show="section.video" id="video" controls="controls" v-bind:src="section.video" class="hidden"/>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  components: {ModalPlayer, Player, Vod, Pagination, BigFile},
  ...
  methods: {
    ...
    afterUpload(resp) {
      ...
      _this.getTime()
      _this.$refs["player"].playUrl(video.path)
    },
