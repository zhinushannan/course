        ...
        <div class="thumbnail search-thumbnail">
          ...
          <div class="caption">
            ...
            <p>
              ...
              &nbsp;
              <button class="btn btn-white btn-xs btn-info btn-round bigger-110" v-on:click="editContent(course)">
                内容
              </button>
              &nbsp;
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-primary" type="button" v-on:click="saveContent()">保存</button>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- 内容modal -->
...
export default {
  ...
  methods: {
    ...
    editContent(course) {
      ...
      Loading.show();
      _this.$ajax.post(process.env.VUE_APP_SERVER + "/business/admin/course/find-content/" + course.id).then((response) => {
        Loading.hide();
        let resp = response.data;
        if (resp.success) {
    ...
    listContentFile() {
      let _this = this
      _this.$ajax.get(process.env.VUE_APP_SERVER + "/business/admin/course-content-file/list/" + _this.course.id).then((rseponse) => {
        let resp = rseponse.data
        if (resp.success) {
