          ...
          <div class="row">
            <div class="col-xs-12 col-sm-2">
              <div class="text-center">
                <img alt="Domain Owner's Avatar" class="thumbnail inline no-margin-bottom" height="150"
            ...
            <div class="col-xs-12 col-sm-3">
              ...
              <form>
                <fieldset>
                  <textarea class="width-100" placeholder="Type something…" resize="none"></textarea>
                </fieldset>
