...
public class VodController {
    ...
    @PostMapping("/vod")
    public ResultBean<FileDTO> fileUpload(@RequestBody FileDTO fileDTO) {
        LOG.info("上传文件开始");
...
//        }
    ...
    public ResultBean<String> getAuth(@PathVariable String vod) throws ClientException {
        LOG.info("获取播放授权开始: ");
        ...
        LOG.info("获取播放授权结束");
        return ResultBean.getSuccess("获取成功！", response.getPlayAuth());
    }
}
